...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskExecution.task_uuid'
        db.alter_column('lizard_task_taskexecution', 'task_uuid', self.gf('django.db.models.fields.CharField')(default=datetime.date(2012, 5, 3), unique=True, max_length=255))


    def backwards(self, orm):
        
        # Changing field 'TaskExecution.task_uuid'
        db.alter_column('lizard_task_taskexecution', 'task_uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True))
