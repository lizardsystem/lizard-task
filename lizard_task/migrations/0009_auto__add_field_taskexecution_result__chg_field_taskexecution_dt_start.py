...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TaskExecution.result'
        db.add_column('lizard_task_taskexecution', 'result', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)

        # Changing field 'TaskExecution.dt_start'
        db.alter_column('lizard_task_taskexecution', 'dt_start', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Deleting field 'TaskExecution.result'
        db.delete_column('lizard_task_taskexecution', 'result')

        # Changing field 'TaskExecution.dt_start'
        db.alter_column('lizard_task_taskexecution', 'dt_start', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'lizard_task.taskexecution': {
            'Meta': {'ordering': "('-dt_start',)", 'object_name': 'TaskExecution'},
            ...
            'dt_start': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'result': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
