...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SecuredPeriodicTask'
        db.create_table('lizard_task_securedperiodictask', (
            ('periodictask_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['djcelery.PeriodicTask'], unique=True, primary_key=True)),
            ('data_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.DataSet'], null=True, blank=True)),
        ))
        db.send_create_signal('lizard_task', ['SecuredPeriodicTask'])


    def backwards(self, orm):
        
        # Deleting model 'SecuredPeriodicTask'
        db.delete_table('lizard_task_securedperiodictask')
