...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TaskLogging.task'
        db.delete_column('lizard_task_tasklogging', 'task_id')

        # Adding field 'TaskLogging.task_execution'
        db.add_column('lizard_task_tasklogging', 'task_execution', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lizard_task.TaskExecution']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'TaskLogging.task'
        raise RuntimeError("Cannot reverse this migration. 'TaskLogging.task' and its values cannot be restored.")

        # Deleting field 'TaskLogging.task_execution'
        db.delete_column('lizard_task_tasklogging', 'task_execution_id')
